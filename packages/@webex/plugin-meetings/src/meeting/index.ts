...
export default class Meeting extends StatelessWebexPlugin {
  ...
  private async getMediaReachabilityMetricFields(): Promise<MediaReachabilityMetrics> {
    ...
    const mediaServerSubnetFirstOctet =
      this.mediaServerIp && this.mediaServerIp.includes('.')
        ? this.mediaServerIp.split('.')[0]
        : null;

    const isSubnetReachable = mediaServerSubnetFirstOctet
      ? // @ts-ignore
        this.webex.meetings.reachability.isSubnetReachable(mediaServerSubnetFirstOctet)
      : null;
    ...
    return {
      ...
      selected_subnet: `${mediaServerSubnetFirstOctet}.X.X.X`,
    };
  }
}
